        ...
        {m.replyTo && (
          <ReplyChipInline
            ...
            onClick={() => {
              ...
              setTimeout(
                () => el.classList.remove("ring-2", "ring-[#0c4a4e]/60"),
                1200
              );
            }}
          />
  ...
  return (
    <main dir="rtl" className="min-h-screen bg-[#f5f7f6] py-6">
      <div className="mx-auto max-w-5xl px-3 sm:px-6">
        <h1 className="mb-4 text-2xl font-extrabold text-[#0c4a4e] sm:text-3xl">
          گفتگو
        </h1>
        ...
        <div className="mb-5 rounded-3xl bg-[#dbe7e6] p-3 shadow-sm ring-1 ring-black/5">
          ...
          <div className="mt-3">
            <textarea
              rows={3}
              placeholder={
                replyingTo ? "پاسخ خود را بنویسید..." : "متن پیام شما..."
              }
              value={draft}
